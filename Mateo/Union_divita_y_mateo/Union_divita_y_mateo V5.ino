...
int Global;
int Y, X, mapX, mapY;
int flg1=0, flg2=0, flg3=0, flag4=0;
...
if(Menu == 3 && flg2 == 1)
{ 
  if(mapY >= 120){Cuad=1;} //para cambiar entre las opciones del menu
  else if(mapY <= 60){Cuad=2;}
...
void manual(){
  ...
  if(milis >= 40)
       ...
       ////////////////// SERVO 1 //////////////////
        ...
        //EXTREMOS, MAYOR A 180 Y MENOR A 0 DEL EJE Y
        if(valorServo >= 180){
          valorServo = 180;
        }
        if(valorServo <= 50){
    ...
    ////////////////// SERVO 2 //////////////////
        ...
        //EXTREMOS, MAYOR A 180 Y MENOR A 0 DEL EJE X
        if(valorServo2 >= 180){
          valorServo2 = 180;
        }
        if(valorServo2 <= 0){
     ...
     */
        servo1.write(valorServo); //IMPRIME EL VALOR EN EL SERVO Y
