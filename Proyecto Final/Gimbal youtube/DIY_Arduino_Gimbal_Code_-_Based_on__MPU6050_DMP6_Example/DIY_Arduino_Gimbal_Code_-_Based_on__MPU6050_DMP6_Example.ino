...
//#include "MPU6050.h" // no es necesario si se usa el archivo incluido de MotionApps

// Se requiere la biblioteca Arduino Wire si se implementa I2Cdev I2CDEV_ARDUINO_WIRE
// is used in I2Cdev.h
