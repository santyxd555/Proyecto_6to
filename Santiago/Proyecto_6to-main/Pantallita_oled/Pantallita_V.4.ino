...
typedef enum{MENU_MANUAL, MENU_AUTOMATICO, MODO_AUTOMATICO_1, MODO_AUTOMATICO_2} estadoMEF;
...
void setup() {
  ...
  display.setCursor(10,20);//1° IZQUIERDA A DERECHA, 2° ARRIBA PARA ABAJO
